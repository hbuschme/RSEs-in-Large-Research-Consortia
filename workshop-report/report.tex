...
First Claude AI aided suggestion for a start: 
Collaborative Research Centres (CRCs) are a cornerstone of Germany's third-party funding landscape, bringing together researchers from different disciplines around shared scientific questions over periods of up to twelve years. As digital tools have become central to the research process — from data collection and analysis through to publication and long-term archiving — CRCs have increasingly pooled these responsibilities in dedicated sub-projects known as INF projects (Informationsinfrastruktur). These units provide research data management (RDM) and research software engineering (RSE) services to all projects within a CRC, while contending with the particular demands of interdisciplinary, long-running collaborations.
